...
You should call only one job action method in the worker handler. This is a bug in the ${this.taskType} worker handler.`));
        ...
        const failJob = (job) => (errorMessageOrFailureConfig, retries) => {
            var _a;
            const errorMessage = typeof errorMessageOrFailureConfig === 'string'
                ? errorMessageOrFailureConfig
                : errorMessageOrFailureConfig
                    .errorMessage;
            const retryBackOff = typeof errorMessageOrFailureConfig === 'string'
                ? 0
                : (_a = errorMessageOrFailureConfig
                    .retryBackOff) !== null && _a !== void 0 ? _a : 0;
